...
#define configMINIMAL_STACK_SIZE                        512                     /* !!!定义空闲任务的栈空间大小, 单位: Word, 1 WORD = 4B 无默认需定义 */
#define configMAX_TASK_NAME_LEN                         32                      /* 定义任务名最大字符数, 默认: 16 */
#define configUSE_16_BIT_TICKS                          0                       /* 1: 定义系统时钟节拍计数器的数据类型为16位 or 32位, 0 = 32位 无默认需定义 */
...
#define configTOTAL_HEAP_SIZE                           ((size_t)(10 * 1024))   /* ----建议修改----动态分配时FreeRTOS堆中可用的RAM总量, 单位: Byte, 无默认需定义 */
